...
<style>
  ...
  .project-card:hover {
    ...
    box-shadow: 0 14px 36px rgba(193,113,79,0.13);
    border-color: #c1714f;
  }
  ...
  .card-tag {
    ...
    top: 0.85rem;
    left: 0.85rem;
    background: rgba(193,113,79,0.88);
    color: #fff;
    font-size: 0.65rem;
    font-weight: 600;
  ...
  .project-card:nth-child(4) { animation: fadeUp 0.5s ease 0.35s both; }
...
<div class="projects-grid">
  ...
  <a class="project-card" href="Assignment2.html">
    ...
    <div class="card-body">
      ...
      <p class="card-desc">Determining stream reachability, barriers, and accessible habitat within the Chinook salmon conservation unit.</p>
      <span class="card-cta">View project →</span>
    </div>
  </a>

  <!-- Card 4 -->
  <a class="project-card" href="Assignment4.html">
    <div class="card-image-wrap">
      <img src="images/land_cover.jpg" alt="Remote sensing and GIS project"
           onerror="this.style.display='none';this.nextElementSibling.style.display='flex'"/>
      <div class="card-placeholder" style="display:none">
        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#555" stroke-width="1.2">
          <rect x="3" y="3" width="18" height="18" rx="2"/>
      ...
      <span class="card-tag">Remote Sensing & GIS</span>
    </div>
    <div class="card-body">
      <h3 class="card-title">Supervised Image Classification</h3>
      <p class="card-desc">Classifying seven land cover classes across the Southern Gulf Islands using a supervised image classification approach.</p>
      <span class="card-cta">View project →</span>
    </div>
  </a>
