...
![](images/workflow.jpg)
<figcaption style="font-size:0.85em; margin-bottom:1.5em; display:block; color:#8a7060; font-style:italic;">
  Figure 1. Workflow of project methods. This diagram illustrates the data inputs for the MaxEnt model, and the resulting outputs including the habitat suitability map and summary statistics to evaluate model performance and reliability.
</figcaption>
...
<figcaption style="font-size:0.85em; margin-bottom:0em; display:block; color:#8a7060; font-style:italic;">
